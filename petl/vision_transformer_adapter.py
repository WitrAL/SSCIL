...
class Adapter(nn.Module):
    def __init__(self,
        ...
        super().__init__()
        self.n_embd = config.d_model if d_model is None else d_model #768
        self.down_size = config.attn_bn if bottleneck is None else bottleneck #64

        #_before
        self.adapter_layernorm_option = adapter_layernorm_option  # none
        ...
        if adapter_scalar == "learnable_scalar":   
            ...
            self.scale = float(adapter_scalar)  #0.1
