...
class MyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.is_ulb:
            ...
            label = self.labels[idx]
            return idx,image,image_strong,label
        else:
            label = self.labels[idx]
...
def _get_idata(dataset_name,use_input_norm,label_percent):
    ...
    if name== "cifar224":
        ...
        return iImageNetR(use_input_norm,label_percent)
    elif name=="imageneta":
        return iImageNetA(use_input_norm,label_percent)
    elif name=="cub":
        return CUB(use_input_norm,label_percent)
